...
{
    internal class ExerciciosRepeticaoParteDois03
    {
        ...
        {
            /*
             * 9. Faça um programa em VS para Ler a quantidade de filhos de cada uma das 30 pessoas que visitaram o zoológico 
             *    num determinado dia, imprimindo:
